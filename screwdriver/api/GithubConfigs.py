...
class GithubConfigs:
    ...
    def __init__(self):
        self.repository = os.environ["GITHUB_REPOSITORY"] if "GITHUB_REPOSITORY" in os.environ else ""
        self.api_url = os.environ["GITHUB_API_URL"] if "GITHUB_API_URL" in os.environ else ""
        self.summary_file = os.environ["GITHUB_STEP_SUMMARY"] if "GITHUB_STEP_SUMMARY" in os.environ else ""
        self.env_variables_file = os.environ["GITHUB_ENV"] if "GITHUB_ENV" in os.environ else ""
        return
